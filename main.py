...
class MainWidget(RelativeLayout):
    ...
    from user_actions import keyboard_closed, on_touch_down, on_keyboard_down, on_touch_up, on_keyboard_up

    menu_widget = ObjectProperty()
    perspective_point_x = NumericProperty(0)
    perspective_point_y = NumericProperty(0)

    V_NB_LINES = 10  # Needs to be EVEN
    ...
    def pre_fill_tiles_coordinates(self):
        tiles = 15  # How many tiles begin in the game
